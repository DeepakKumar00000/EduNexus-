                ...
                <div className="hidden sm:flex w-1/5 flex-col gap-2 px-2 py-3">
                  ...
                  {course.progressPercentage === 100 && (
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        generateCertificate(course._id, token);
                      }}
                      className="mt-2 flex items-center gap-2 text-sm text-yellow-50 bg-richblack-700 py-1 px-2 rounded-md hover:bg-richblack-600 transition-all"
                    >
                      <FaDownload size={14} />
