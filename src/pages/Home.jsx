    ...
    return (
        <React.Fragment>
            ...
            <div className=' '>
                ...
                <div className='relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center justify-between'>
                    ...
                    <div>
                        <CodeBlocks
                            ...
                            heading={
                                <div className="w-[100%] text-3xl lg:text-4xl font-semibold lg:w-[50%] text-white">
                                    Start
                ...
                {/*Section 2  */}
                <div className='bg-pure-greys-5 text-richblack-700 pt-8'>
                    ...
                    <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between'>
                        <div className='flex flex-col lg:flex-row gap-5'>
                            ...
                            <div className='flex flex-col w-full lg:w-[40%] items-start'>
